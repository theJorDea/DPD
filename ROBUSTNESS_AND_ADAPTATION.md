...
Три дешёвых APA spline-кандидата пока имеют только within-capture
...
- residual-guided lag-9 sparse spline-memory
  (parent + `(8,0),(9,0),(10,0)`, `K=12`):
  −37.792478 dB full OOF NMSE и −37.860728 dB reused validation при
  72 MUL/sample.
