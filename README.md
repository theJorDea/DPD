...
docs/notebooks/            ровно два notebook-файла и подробный HTML
...
подтверждённого эксперимента. Отклонённые варианты не входят в рабочий
datapath и не должны смешиваться с baseline-результатами.
...
Последняя полная проверка в окружении NumPy: `397` тестов пройдено, `16` ожидаемо пропущены из-за отсутствия
